...
class VolCrudController extends AbstractCrudController
{
    ...
    public function configureFields(string $pageName): iterable
    {
        return [
            ...
            TextField::new('notes'),
            TextField::new('objet'),
            IntegerField::new('estimation'),
            DateField::new('date'),
            AssociationField::new('citoyen')->setCrudController(CitoyenCrudController::class)->hideWhenUpdating(),
            AssociationField::new('suspect')->setCrudController(CitoyenCrudController::class)->hideWhenUpdating(),
